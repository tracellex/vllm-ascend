...
class AscendSpecDecodeBaseProposer(SpecDecodeBaseProposer):
    ...
    def _propose(
        ...
        for attn_group in self.draft_attn_groups:
            ...
            group_common_attn_metadata.slot_mapping = group_block_table.slot_mapping.gpu
    ...
    def model_returns_tuple(self) -> bool:
        if self.method == "mtp":
            ...
            return any(
                ...
                for architecture in ("DeepSeekMTPModel", "Glm5NextMTPModel")
            )
    ...
    def attn_update_stack_num_spec_norm(
        ...
        if pcp_manager is not None:
            ...
            slot_mapping_buffer[: batch_size * self.pcp_size] = slot_mapping
            slot_mapping_buffer[batch_size * self.pcp_size :].fill_(PADDING_SLOT_ID)
